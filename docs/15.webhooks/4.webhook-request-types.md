...
> [!WARNING]
> A bot can read non-command/queries messages only if its `privacy mode` is disabled. To change a bot privacy settings see [this guide](../11.quickstart/1.new-bot#privacy)
...
The full chat message data can be retrieved through the [`DefStudio\Telegraph\DTO\Message`](../12.features/9.dto#message) DTO:
...
The full callback query data can be retrieved through the [`DefStudio\Telegraph\DTO\CallbackQuery`](../12.features/9.dto#CallbackQuery) DTO
...
Users can interact with a bot through inline queries calling it by typing its name followed by the query. The query is sent to the webhook (or can be [manually polled](8.manual-polling)) wrapped in a [`DefStudio\Telegraph\DTO\InlineQuery`](../12.features/9.dto#InlineQuery). For more information see [inline bot page](https://core.telegram.org/bots/inline) and [the official api documentation](https://core.telegram.org/bots/api#inline-mode)
...
- Article ([`DefStudio\Telegraph\DTO\InlineQueryResultArticle`](../12.features/9.dto#inlineQueryResultArticle))
- Audio ([`DefStudio\Telegraph\DTO\InlineQueryResultAudio`](../12.features/9.dto#inlineQueryResultAudio))
- Contact ([`DefStudio\Telegraph\DTO\InlineQueryResultContact`](../12.features/9.dto#inlineQueryResultContact))
- Game (coming soon)
- Document ([`DefStudio\Telegraph\DTO\InlineQueryResultDocument`](../12.features/9.dto#inlineQueryResultDocument))
- Gif ([`DefStudio\Telegraph\DTO\InlineQueryResultGif`](../12.features/9.dto#inlineQueryResultGif))
- Location ([`DefStudio\Telegraph\DTO\InlineQueryResultLocation`](../12.features/9.dto#inlineQueryResultLocation))
- Mpeg4Gif ([`DefStudio\Telegraph\DTO\InlineQueryResultMpeg4Gif`](../12.features/9.dto#inlineQueryResultMpeg4Gif))
- Photo ([`DefStudio\Telegraph\DTO\InlineQueryResultPhoto`](../12.features/9.dto#inlineQueryResultPhoto))
- Venue ([`DefStudio\Telegraph\DTO\InlineQueryResultVenue`](../12.features/9.dto#inlineQueryResultVenue))
- Video ([`DefStudio\Telegraph\DTO\InlineQueryResultVideo`](../12.features/9.dto#inlineQueryResultVideo))
- Voice ([`DefStudio\Telegraph\DTO\InlineQueryResultVoice`](../12.features/9.dto#inlineQueryResultVoice))
