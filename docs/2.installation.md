...
In order to interact with Telegram, a new bot should be created and associated with a Telegram bot. Follow the  [quickstart guide](/docs/11.quickstart/1.new-bot.md) for an overview of this.
