...
->keyboard(Keyboard::make()->buttons([
        Button::make('Danger Button')->url('https://test.it')->style(\DefStudio\Telegraph\Enums\ButtonStyle::danger),
...
->keyboard(function(Keyboard $keyboard){
    return $keyboard
        ->button('Danger Button')->url('https://test.it')->style(\DefStudio\Telegraph\Enums\ButtonStyle::danger)
...
Define the `style`. Must be one of “danger” (red), “success” (green) or “primary” (blue). If omitted, then an app-specific style is used

```php
Button::make('open')->url('https://test.it')->style(\DefStudio\Telegraph\Enums\ButtonStyle::danger),
```
...
Define text to copy to the clipboard when the button is pressed (see `copy_text` in [Telegram Bot docs](https://core.telegram.org/constructor/keyboardButtonCopy) for reference):
