...
- `->richMessage()` (optional) an instance of [`Rich Message`](#richmessage) holding data about the contained Rich Message
...
More information on the [RichMessage](12.rich-messages#RichMessage) page.
